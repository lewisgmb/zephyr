    ...
    <div class="ab-calendar-inner panel-body">
        <div ng-app=appointmentForm>
            ...
            <div class="well">
                ...
                <hr>
                <a class="btn btn-info" href="<?php echo \Bookly\Lib\Utils\Common::escAdminUrl( Bookly\Backend\Modules\Staff\Controller::page_slug ) ?>"><?php _e( 'Add Staff Members', 'bookly' ) ?></a>
