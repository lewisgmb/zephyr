...
<tr><td><input value="[[APPROVE_APPOINTMENT_URL]]" readonly="readonly" onclick="this.select()" /> - <?php echo esc_html( __('URL of approve appointment link (to use inside <a> tag)', 'bookly') ) ?></td></tr>
<tr><td><input value="[[CANCEL_APPOINTMENT]]" readonly="readonly" onclick="this.select()" /> - <?php _e('cancel appointment link', 'bookly') ?></td></tr>
<tr><td><input value="[[CANCEL_APPOINTMENT_URL]]" readonly="readonly" onclick="this.select()" /> - <?php echo esc_html( __('URL of cancel appointment link (to use inside <a> tag)', 'bookly') ) ?></td></tr>
...
<?php do_action( 'bookly_extras_render_notification_codes' ) ?>
<tr><td><input value="[[GOOGLE_CALENDAR_URL]]" readonly="readonly" onclick="this.select()" /> - <?php echo esc_html( __('URL for adding event to client\'s Google Calendar (to use inside <a> tag)', 'bookly') ) ?></td></tr>
