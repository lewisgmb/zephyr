...
class Service extends \Bookly\Lib\Form
{
    ...
    {
        $this->setFields( array( 'id', 'title', 'duration', 'price', 'category_id', 'color', 'capacity', 'padding_left', 'padding_right', 'info', 'type', 'sub_services', 'visibility' ) );
    }
    ...
    public function save()
    {
        ...
        if ( $this->data['type'] == \Bookly\Lib\Entities\Service::TYPE_SIMPLE || ! array_key_exists( 'sub_services', $this->data ) || empty( $this->data['sub_services'] ) ) {
