...
<form method="post" action="<?php echo esc_url( add_query_arg( 'tab', 'general' ) ) ?>" enctype="multipart/form-data" class="ab-settings-form">
    ...
    <div class="form-group">
        ...
        <?php \Bookly\Lib\Utils\Common::optionToggle( 'ab_settings_default_appointment_status', array( array( \Bookly\Lib\Entities\CustomerAppointment::STATUS_PENDING, __( 'Pending', 'bookly' ) ), array( \Bookly\Lib\Entities\CustomerAppointment::STATUS_APPROVED, __( 'Approved', 'bookly' ) ) ) ) ?>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" name="ab_settings_approve_page_url" id="ab_settings_approve_page_url" value="<?php echo esc_attr( get_option( 'ab_settings_approve_page_url' ) ) ?>" placeholder="<?php esc_attr_e( 'Enter a URL', 'bookly' ) ?>" />
    </div>
    <div class="form-group">
