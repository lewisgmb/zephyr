...
class Controller extends Lib\Controller
{
    ...
    public function index()
    {
            ...
            switch ( $this->getParameter( 'tab' ) ) {
                ...
                case 'purchase_code':  // Purchase Code form.
                    ...
                    if ( empty( $errors ) ) {
                        ...
                        $message[ $this->getParameter( 'tab' ) ] = implode( '<br>', $errors );
                    }
                    break;
                ...
                case 'company':  // Company form.
                    ...
                    break;
                default:
                    $response = apply_filters( 'bookly_save_settings', array(), $this->getParameter( 'tab' ), $this->getPostParameters() );
        ...
        $cart_columns = array(
            'service'  => \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_service' ),
            'date'     => __( 'Date',  'bookly' ),
            'time'     => __( 'Time',  'bookly' ),
            'employee' => \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_employee' ),
            'price'    => __( 'Price', 'bookly' ),
        );

        $this->render( 'index', compact( 'holidays', 'candidates', 'message', 'wc_cart_error_message', 'notice_class', 'cart_columns' ) );
    } // index
    ...
    public function showAdminNotice()
    {
        if ( Lib\Utils\Common::isCurrentUserAdmin() &&
             get_option( Lib\Plugin::PURCHASE_CODE ) == '' &&
        ...
        do_action( 'bookly_render_admin_notice' );
    }
