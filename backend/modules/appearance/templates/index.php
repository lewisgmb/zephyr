        ...
        <div id="ab-appearance">
            <form method=post id=common_settings>
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label>
                            <input id=ab-required-employee-checkbox name=ab-required-employee-checkbox <?php checked( get_option( 'ab_appearance_required_employee' ) ) ?> type="checkbox" />
                            <b><?php _e( 'Make selecting employee required', 'bookly' ) ?></b>
                        </label>
                    </div>
                </div>
            </form>
