...
<tr><td><input value="[[CART_INFO]]" readonly="readonly" onclick="this.select()" /> - <?php _e( 'cart information', 'bookly' ) ?></td></tr>
<tr><td><input value="[[CART_INFO_C]]" readonly="readonly" onclick="this.select()" /> - <?php _e( 'cart information with cancel', 'bookly' ) ?></td></tr>
