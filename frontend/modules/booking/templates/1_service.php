...
<div class="ab-service-step">
    ...
    <div class="help-select-text">

        <div class="entry-title">
                            <h2>Choisir un aidant ou une aidantes </h2>
                    </div>


        <div class="entry-content">
          Les personnes suivantes sont disponibles pour vous offrir du r&eacute;pit dans votre r&eacute;gion. Si vous avez des questions ou &eacute;prouvez des difficult&eacute;s, n'h&eacute;sitez pas &agrave; contacter le Z&eacute;phyr au XXX-XXX-XXXX.</div>
...
<ul class="cards" id="help-card-grid">
            ...
            <table id="staff-list" class="helpers-list">
              <thead>
                <th>name</th>
                <th>isRCR</th>
                <th>isPDSB</th>
...
<div style="text-align: center;display: none;padding: 50px 0 50px 0"><img src="<?php echo includes_url( 'js/tinymce/skins/lightgray/img/loader.gif' ) ?>" alt="<?php esc_attr_e( 'Loading...', 'bookly' ) ?>" /></div>
