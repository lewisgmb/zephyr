...
class Staff extends Lib\Entity
{
    ...
    protected static $schema = array(
        ...
        'mobile' => array( 'format' => '%s' ),
        'female' => array( 'format' => '%s' ),
        'region1' => array( 'format' => '%s' ),
        'region2' => array( 'format' => '%s' ),
        'region3'=> array( 'format' => '%s' ),
        'smoker' => array( 'format' => '%s' ),
        'smokerEnv' => array( 'format' => '%s' ),
        'allergy'    => array( 'format' => '%s' ),
        'rcrcert' => array( 'format' => '%s' ),
        'pdsbcert' => array( 'format' => '%s' ),
        'aslcert' => array( 'format' => '%s' ),
        'filecert' => array( 'format' => '%s' ),
        'service_diaper' => array( 'format' => '%s' ),
        'service_bath' => array( 'format' => '%s' ),
        'service_medication' => array( 'format' => '%s' ),
        'service_behavior' => array( 'format' => '%s' ),
        'service_forcefeed' => array( 'format' => '%s' ),
        'service_transport' => array( 'format' => '%s' ),
        'service_chair' => array( 'format' => '%s' ),
        'service_epilepsy' => array( 'format' => '%s' ),
    );
        ...
        foreach ( $appointments as $key => $appointment ) {
            ...
            if ( $appointment['number_of_persons'] == $appointment['total_number_of_persons'] ) {
                ...
                if ( $appointment['extras'] != '[]' ) {
                    ...
                    $extras = apply_filters( 'bookly_extras_find_by_ids', array(), json_decode( $appointment['extras'], true ) );
                    if ( ! empty ( $extras ) ) {
                        $desc .= sprintf(
                            '<br/><div>%s: %s</div>',
                            __( 'Extras', 'bookly' ),
