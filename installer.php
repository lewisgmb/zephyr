...
class Installer
{
    ...
    public function __construct()
    {
        ...
        $this->options = array(
            ...
            'ab_settings_default_appointment_status' => Lib\Entities\CustomerAppointment::STATUS_APPROVED,
            ...
            'ab_settings_cart_notifications_combined' => '1',
            'ab_cart_show_columns'                   => array( 'service' => array( 'show' => 1 ), 'date' => array( 'show' => 1 ), 'time' => array( 'show' => 1 ), 'employee' => array( 'show' => 1 ), 'price' => array( 'show' => 1 ) ),
            // Business hours.
    ...
    private function _remove_l10n_data()
    {
        global $wpdb;
    ...
    private function _create_tables()
    {
        ...
        $wpdb->query(
            'CREATE TABLE IF NOT EXISTS `' . Lib\Entities\Staff::getTableName() . '` (
                ...
                `mobile`             VARCHAR(128),
                `smoker`             VARCHAR(128),
                `smokerEnv`          VARCHAR(128),
                `allergy`            VARCHAR(128),
                `rcrcert`            VARCHAR(128),
                `pdsbcert`           VARCHAR(128),
                `aslcert`            VARCHAR(128),
                `filecert`           VARCHAR(128),
                `adultcare`          VARCHAR(128),
                `teencare`           VARCHAR(128),
                `kidcare`            VARCHAR(128),
                `babycare`           VARCHAR(128),
                `service_diaper`     VARCHAR(128),
                `service_bath`       VARCHAR(128),
                `service_behavior`   VARCHAR(128),
                `service_medication` VARCHAR(128),
                `service_forcefeed`  VARCHAR(128),
                `service_transport`  VARCHAR(128),
                `service_chair`      VARCHAR(128),
                `service_epilepsy`   VARCHAR(128);
        ...
        $wpdb->query(
            'CREATE TABLE IF NOT EXISTS `' . Lib\Entities\CustomerAppointment::getTableName() . '` (
                ...
                CONSTRAINT
                    ...
                    REFERENCES ' . Lib\Entities\Payment::getTableName() . '(id)
                    ON DELETE SET NULL
                    ON UPDATE NO ACTION
            ) ENGINE = INNODB
            DEFAULT CHARACTER SET = utf8
